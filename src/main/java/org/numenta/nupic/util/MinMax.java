...
/**
 * Holds two values, a min and a max. Can later be developed to employ
 * operations on those values (i.e. distance etc.)
 *
 * @author David Ray
 */
public class MinMax {
	...
	public static MinMax of(int[] array) {
		...
		for (int next : array) {
			if (min == Integer.MIN_VALUE || next < min) {
				min = next;
			}
	 ...
	 *
	 * @param min
	 *            the minimum or lower bound
	 * @param max
	 *            the maximum or upper bound
	 */
