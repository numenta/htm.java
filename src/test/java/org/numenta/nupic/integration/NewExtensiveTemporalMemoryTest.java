    ...
    private List<Set<Integer>> translateSequence(String s) {
        ...
        for(String numList : sa) {
            ...
            Set<Integer> set = Arrays.stream(nums).map(
                n -> Integer.parseInt(n)).collect(Collectors.toCollection(LinkedHashSet::new));
            retVal.add(set);
        }
